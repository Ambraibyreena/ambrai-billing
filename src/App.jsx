...
import { Receipt, Package, LogOut, Tag, BarChart3 } from "lucide-react";
  ...
  return (
    <AuthGate>
      <div className="min-h-screen flex flex-col">
        ...
        {tab === "billing" ? <BillingScreen /> : tab === "products" ? <ProductManagement /> : tab === "labels" ? <LabelPrinting /> : <Reports />}
      </div>
    </AuthGate>
  );
}
